...
| F07 | Respect fenced Markdown and preserve task structure when adopting/reordering | Shared parser/writer fixed: protected Markdown excluded consistently; unsafe structural edits reject losslessly; 37 context tests including list-container fences/nested HTML, whole 1,452-unit run and 16 related Worker tests pass. Backend migration/gating for previously scheduled examples remains in progress |
