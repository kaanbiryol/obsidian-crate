...
.pwa-reminders-view{position:fixed;inset:0;flex:1;min-height:0;width:100%;max-width:100vw;height:auto;display:flex;flex-direction:column;overflow:visible;--pwa-tabbar-content-height:64px;--reminders-tabbar-height:calc(var(--pwa-tabbar-content-height) + env(safe-area-inset-bottom));--reminders-tabbar-overlay:var(--reminders-tabbar-height);--reminders-tabbar-bottom-offset:0px;--reminders-bottom-gap:16px;--reminders-fab-gap:18px;--reminders-fab-size:56px;--reminders-safe-area:0px;--pwa-tabbar-safe-area:env(safe-area-inset-bottom);--pwa-tabbar-bleed:0px;background:var(--background-primary)}
