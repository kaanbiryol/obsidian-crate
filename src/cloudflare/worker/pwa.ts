...
.pwa-reminders-view{position:relative;flex:1;min-height:0;width:100%;max-width:100vw;height:100dvh;display:flex;flex-direction:column;overflow:hidden;--reminders-tabbar-height:64px;--reminders-tabbar-overlay:var(--reminders-tabbar-height);--reminders-tabbar-bottom-offset:0px;--reminders-bottom-gap:16px;--reminders-fab-gap:18px;--reminders-fab-size:56px;--reminders-safe-area:0px;--pwa-tabbar-safe-area:0px;background:var(--background-primary)}
...
.pwa-reminders-view .bottom-tab-bar{width:100vw;max-width:100vw;height:var(--reminders-tabbar-height);overflow:hidden}
.pwa-reminders-view .bottom-tab-bar>div{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;width:100%;height:var(--reminders-tabbar-height);max-width:none!important;padding:4px 8px!important}
.pwa-reminders-view .bottom-tab-bar [data-action="switch-tab"]{width:100%!important;max-width:100%!important;min-width:0!important;height:56px!important;min-height:0!important;padding:4px 2px!important}
