...
.pwa-reminders-view.is-fullscreen .animated-tab-bar-bottom{position:fixed;bottom:0;left:0;right:0;flex-shrink:0;margin-bottom:0;transform:translate3d(0,env(safe-area-inset-bottom),0)}
