...
describe('PWA activation metadata', () => {
	...
	it('keeps standalone safe areas outside visible navigation chrome', () => {
		...
		expect(html).toContain('body{position:fixed;overflow:hidden;width:100%;height:100%;top:0;left:0}');
		...
		expect(html).toContain('position:fixed;bottom:0;left:0;right:0;flex-shrink:0;margin-bottom:0;transform:none');
