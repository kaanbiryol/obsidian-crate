...
export function ReadingDialog({ title, onClose, busy = false, children }: { title: string; onClose: () => void; busy?: boolean; children: React.ReactNode }) {
	...
	return <div ref={marker}><BaseModal onClose={onClose} dismissible={!busy} ariaLabel={title} variant={mobile ? 'bottom-sheet' : 'centered'} className="crate-reading-dialog"
