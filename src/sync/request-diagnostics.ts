...
const routes = new Set([
	...
	...['manifest', 'metadata', 'upload', 'download', 'delete', 'changes', 'check', 'batch-upload', 'batch-download', 'batch-delete', 'versions', 'version-preview', 'restore', 'restore-version'].map(route => `/sync/${route}`),
