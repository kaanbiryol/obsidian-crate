...
If **Offline copy unavailable** appears, close older Crate tabs and select **Rebuild offline copy** while connected. This refreshes confirmed data and preserves pending changes and drafts. Unknown newer formats are left intact; see [browser storage recovery](docs/pwa-storage-recovery.md).
